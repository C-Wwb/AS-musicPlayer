package com.example.musicplayer.adater;
...
import com.example.musicplayer.ServiceImpl.SongSheetServiceImpl;
...
public class SongSheetAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.imageView.setImageResource(R.drawable.logo6);
