...
import com.example.musicplayer.Service.MusicChangedListener;
import com.example.musicplayer.Service.MusicPlayingChangedListener;
import com.example.musicplayer.Service.MusicService;
import com.example.musicplayer.ServiceImpl.MusicServiceImpl;
        ...
        ImageView_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (musicService.isPlaying()) {
                    ImageView_play.setImageResource(R.drawable.ic_pause_black);
                } else {
                    ImageView_play.setImageResource(R.drawable.ic_play_black);
                }
            }
        });
